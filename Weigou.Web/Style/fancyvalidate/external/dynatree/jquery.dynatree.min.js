// jquery.dynatree.js build 1.2.1_rc2
// Revision: 573, date: 2011-12-29 10:03:36
...
$.ui.dynatree.version="$Version: 1.2.1_rc2$";$.ui.dynatree.getNode=function(el){if(el instanceof DynaTreeNode){return el;}
...
return sourceNode.tree._onDragEvent("helper",sourceNode,null,event,null,null);},start:function(event,ui){var sourceNode=$.ui.dynatree.getNode(event.target);if(!sourceNode){return false;}},_last:null});}
