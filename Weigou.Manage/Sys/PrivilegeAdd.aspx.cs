...
{
    public partial class PrivilegeAdd : ManagePage
    {
        /// <summary>
        /// 修改的资源编码
        /// </summary>
        ...
        private void BindInfo()
        {
            ...
            //返回列表按钮
            this.backUrl.HRef = "PrivilegeList.aspx?ParentCode=" + ParentCode;
        }
        /// <summary>
        /// 添加事件
        /// </summary>
        ...
        protected void BtnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (res > 0)
                ShowMsg("/Sys/PrivilegeList.aspx?ParentCode=" + ParentCode, "恭喜您，操作成功");
            else
                ShowMsg("/Sys/PrivilegeList.aspx?ParentCode=" + ParentCode, "很抱歉，操作失败,请重试！");
        }
    }
}