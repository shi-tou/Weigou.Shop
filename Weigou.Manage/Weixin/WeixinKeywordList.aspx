<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WeixinKeywordList.aspx.cs" Inherits="Weigou.Manage.Weixin.WeixinKeywordList" %>
...
<body>
    <form id="form_UserList" runat="server">
        <div class="ibox">
            <div class="ibox-title">
                ...
                <div class="ibox-tools">
                    <a href="WeixinKeywordAdd.aspx" class="btn btn-success btn-sm">
        ...
        <table class="table table-hover table-bordered ">
            ...
            <tbody>
                <asp:Repeater runat="server" ID="repKeyword" OnItemCommand="repKeyword_ItemCommand" >
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <a href="WeixinKeywordAdd.aspx?ID=<%#Eval("ID") %>" class="btn btn-danger btn-sm"><i class="fa fa-edit"></i>&nbsp;编辑</a>
