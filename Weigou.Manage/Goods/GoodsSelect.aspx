<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsSelect.aspx.cs" Inherits="Weigou.Manage.Goods.GoodsSelect" %>
        ...
        <div id="tb">
            <table>
                <tr>
                    ...
                    <th>商品类别：</th>
                    <td>
                        <asp:TextBox runat="server" ID="txtTypeName" title="请选择商品分类" CssClass="form-control" Enabled="false"></asp:TextBox>
