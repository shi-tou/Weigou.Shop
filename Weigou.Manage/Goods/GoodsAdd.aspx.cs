...
{
    public partial class GoodsAdd : ManagePage
    {
        /// <summary>
        /// 商品ID
        /// </summary>
        ...
        private void LoadGoodsExtControl()
        {
            ...
            DataTable dt = goodsService.GetGoodsAttribute(Convert.ToInt32(this.ddlType.SelectedValue.Trim()));
        ...
        private void LoadGoodsBrandControl()
        {
            ...
            DataTable dt = goodsService.GetBrandByTypeID(this.ddlType.SelectedValue.Trim());
        ...
        protected void BtnSubmit_Click(object sender, EventArgs e)
        {
            ...
            dr["Type"] = this.ddlType.SelectedValue.Trim();
            ...
            {
                SaveAttr(goodsID); 
                ShowMsg("/Goods/GoodsList.aspx", "恭喜您，操作成功！");
            }
            else
            { 
                ShowMsg("/Goods/GoodsAdd.aspx?ID="+_ID, "很抱歉，操作失败,请重试！");
            }
        }
