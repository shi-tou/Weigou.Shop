<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsBrandSet.aspx.cs" Inherits="Weigou.Manage.Goods.GoodsBrandSet" ValidateRequest="false" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="/JScript/highlight.js"></script>
    <script language="javascript" type="text/javascript">
        $(function () {
            $('#txtKey').bind('keyup', function (ev) {
    ...
    <form id="form1" runat="server">
        <div class="ibox">
            ...
            <table class="form form-horizontal">
                ...
                <tr>
                    <td style="width: 150px;" class="tr">输入品牌名称查找：</td>
                    <td>
