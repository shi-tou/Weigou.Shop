<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsAttributeSet.aspx.cs" Inherits="Weigou.Admin.Goods.GoodsAttributeSet" ValidateRequest="false" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table class="infotable" cellpadding="0px" cellspacing="1px">
                ...
                <tr>
                    <td style="width: 150px;" class="tr">输入属性名称高亮查找：</td>
                    <td>
