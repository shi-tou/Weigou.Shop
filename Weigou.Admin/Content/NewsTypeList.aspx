<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsTypeList.aspx.cs" Inherits="Weigou.Admin.News.NewsTypeList" %>
...
<head runat="server">
    <title>文章管理-<%=PageTitle %></title>
    <script src="js/newstype.js" type="text/javascript"></script>
</head>
<body>
