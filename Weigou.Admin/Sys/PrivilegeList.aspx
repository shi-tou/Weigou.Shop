<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrivilegeList.aspx.cs" Inherits="Weigou.Admin.Sys.PrivilegeList" %>
...
<head runat="server">
    <title>资源管理-<%=PageTitle %></title>
    <script src="js/privilege.js" type="text/javascript"></script>
</head>
<body>
