<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MallOrderReturnDetail.aspx.cs" Inherits="Weigou.Admin.Order.MallOrderReturnDetail" %>
...
<body>
    <form id="form1" runat="server">
        <div class="easyui-panel p10" data-options="title:'退款基本信息',iconCls:'icon-tip'">
            ...
            <div class="action">
                <asp:Button runat="server" ID="BtnAgree" Text="同意退款" CssClass="btn" OnClick="BtnAgree_Click" OnClientClick="return AgreeRefund();" />
                <asp:Button runat="server" ID="BtnShip" Text="立即发货" CssClass="btn" OnClick="BtnShip_Click" OnClientClick="return AgreeShip();" />
