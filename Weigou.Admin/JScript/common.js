...
function PrintThisPage() {
    ...
    winprint.document.write('<link href="/JScript/easyui/themes/ui-cupertino/easyui.css" rel="stylesheet" type="text/css"/>');
    winprint.document.write('<link href="/JScript/easyui/themes/icon.css" rel="stylesheet" type="text/css"/>');
    winprint.document.write('<link href="/Style/admin.css" rel="stylesheet" type="text/css"/>');
    winprint.document.write('<script src="/JScript/easyui/jquery-1.8.0.min.js" type="text/javascript"></script>');
    winprint.document.write('<script src="/JScript/easyui/jquery.easyui.min.js" type="text/javascript"></script>');
    winprint.document.write('<script src="/JScript/layer/layer.min.js" type="text/javascript"></script>');
    winprint.document.write('<script src="/JScript/global.js" type="text/javascript"></script>');
    winprint.document.write('<script src="/JScript/customValidate.js" type="text/javascript"></script>');
    winprint.document.write('<script src="/JScript/euiHelper.js" type="text/javascript"></script>');
