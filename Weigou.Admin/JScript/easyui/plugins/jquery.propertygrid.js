...
$(_3).datagrid($.extend({},_5,{cls:"propertygrid",view:(_5.showRole?_6:undefined),onClickRow:function(_7,_8){
if(_1!=this){
_c(_1);
_1=this;
}
...
var t=$(_15);
return $.extend({},$.fn.datagrid.parseOptions(_15),$.parser.parseOptions(_15,[{showRole:"boolean"}]));
};
...
$(_24).datagrid("collapseRole",e.data.groupIndex);
}else{
$(_24).datagrid("expandRole",e.data.groupIndex);
}
});
});
...
$.extend($.fn.datagrid.methods,{expandRole:function(jq,_34){
...
$.fn.propertygrid.defaults=$.extend({},$.fn.datagrid.defaults,{singleSelect:true,remoteSort:false,fitColumns:true,loadMsg:"",frozenColumns:[[{field:"f",width:16,resizable:false}]],columns:[[{field:"name",title:"Name",width:100,sortable:true},{field:"value",title:"Value",width:100,resizable:false}]],showRole:false,groupField:"group",groupFormatter:function(_3c,_3d){
return _3c;
}});
})(jQuery);
