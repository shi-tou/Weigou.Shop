<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SmsSend.aspx.cs" Inherits="Weigou.Admin.Sms.SmsSend" %>
    ...
    <div class="easyui-panel" title="发送短信">
        <table class="infotable" >
            <tr>
                ...
                <td>
                    ...
                    <table>
                        <tr>
                            <td>
                                <asp:ListBox runat="server" ID="lbMobileNo" Width="290px" CssClass="txt" Height="100px"></asp:ListBox><br />
                            ...
                            <td >
                                <asp:TextBox runat="server" ID="txtMobile" class="txt" TextMode="MultiLine" Width="270px" Height="100px"></asp:TextBox><br />
            ...
            <tr id="trPresetTime">
                ...
                <td><asp:TextBox ID="txtPresetTime" runat="server" class="easyui-validatebox txt"  data-options="required:true" missingmessage="请选择定时发送时间"  onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',minDate:'%y-%M-%d %H:%m'})"></asp:TextBox></td>
            </tr>
            <tr>
                <td class="tr">模板内容：</td>
                <td>
                    <table>
                        <tr>
                            <td><asp:TextBox ID="txtContent" runat="server" CssClass="easyui-validatebox txt" data-options="required:true" missingmessage="请输入内容或选择模板" TextMode="MultiLine" style="width:280px;height:100px; font-size:12px;" ></asp:TextBox></td>
                            <td>
